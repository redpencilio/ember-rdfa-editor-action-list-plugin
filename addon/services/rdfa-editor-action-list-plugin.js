 ...
 * @class RdfaEditorActionListPlugin
 * @constructor
 * @extends EmberService
 */
const RdfaEditorActionListPlugin = Service.extend({
  ...
  detectRelevantContext(context){
    ...
    return lastTriple.predicate === 'a' &&
           lastTriple.object === 'http://data.notable.redpencil.io/#ActionList';
  },
...
RdfaEditorActionListPlugin.reopen({
  who: 'editor-plugins/action-list-card'
});
export default RdfaEditorActionListPlugin;
